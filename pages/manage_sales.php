                  ...
                  <td><?php echo $getSale->pay_status ?></td>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="invoice?guidID=<?php echo $getSale->sales_ID ?>" class="btn btn-success"><i class="fas fa-eye"></i></a>
                        <a href="edit_sale?guidID=<?php echo $getSale->sales_ID ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                        <a href="delete_sale?guidID=<?php echo $getSale->sales_ID ?>" onclick="return confirm('Are you sure you want to delete Sale?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                     <?php   }
