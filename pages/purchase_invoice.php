        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-money"></i>PURCHASE  INVOICE </h3>
                  </div>
                  <div class="col-md-8">
           ...
           if ($getPurchases !=0) {
              foreach ($getPurchases as $getPurchase) {
                ...
                $Discount=$getPurchase->total_discount;
                 $total=$getPurchase->gtotal_amount - $Discount;
            ...
            <div class="invoice p-3 mb-3" id="print">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  Purchase Date: 
                <?php echo date('d F Y',strtotime($purchase_date)) ; ?>
                </div>
                <!-- /.col -->
              </div>
              <!-- /.row -->
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      $x++;
                      $sub_total +=$getDetail->total_amount;
                      ...
                      <td><?php echo $getDetail->batch_id;?></td>
                      <td><?php echo $getDetail->qty;?></td>
                      <td><?php echo $getDetail->supplier_price;?></td>
                      <td><?php echo$getDetail->discount;?></td>
                      <td><?php echo $getDetail->total_amount;?></td>
                     </tr>
                       <?php
                           }
                           }
