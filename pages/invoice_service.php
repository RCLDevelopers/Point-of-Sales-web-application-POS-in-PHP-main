        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i> INVOICE </h3>
                  </div>
                  <div class="col-md-8">
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <?php
                     $getDetails=getServiceSalesDetailsBySalesID($sales_ID);
                      if ($getDetails !=0) {
                        $x=0;
                      ...
                      $service_ID=$getDetail->service_ID;
