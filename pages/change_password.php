        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-"></i> CHANGE PASSWORD </h3>
                  </div>
                  <div class="col-md-8">
          ...
          <div class="card card-">
              ...
              if (isset($_POST['submit'])) {
                ...
                $password=md5($password);
                 $create=changePassword($password);
                 if ($create =='success') {
                        $activity= $_SESSION['user_ID'].' Updated password ';
                          createActivity_logs($activity);
                        echo '<script> alert("Password Changed Successfully") </script>';
                 
                    echo '<script> window.location="change_password" </script>';
              ...
              <form method="POST" action="change_password" class="form form-responsive" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="row form-group">
                  ...
                  <label for="password" class="">Confirm Password </label>
                    ...
                    <input type="password" class="form-control" id="confirmPassword" name="confirmPassword" placeholder="Confirm Password" onkeyup="checkPass(this.value)" required>
...
<script type="text/javascript">
 ...
 var password=document.getElementById('password').value;
    if (password == confirmPass) {
      ...
      document.getElementById('displayMessage').innerHTML='<b style="color:green">Correct Password</b>'
    }else{
     document.getElementById('displayMessage').innerHTML='<b style="color:red">Password Mismatch</b>'
    }
  }
</script>
