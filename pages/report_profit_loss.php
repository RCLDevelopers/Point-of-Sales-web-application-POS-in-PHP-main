        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i>PROFIT/LOSS REPORT </h3>
                  </div>
                  <div class="col-md-8">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <!-- Main content -->
            <form method="POST" action="report_profit_loss">
              <div class="row">
              ...
              <div class="row">
                <div class="col-12 table-responsive p-0">
                  ...
                  $fromstr=strtotime($from);$tostr=strtotime($to);
                   ?>
                  <h4 style="text-align: center;"> <b style="color: #17A589">Sales Report  From <?php echo date('D d S m,Y',$fromstr); ?> TO <?php echo date('D d S m,Y',$tostr); ?> </b></h4>
                  <?php }else{ ?>
                 <h4 style="text-align: center;"> <b style="color: #17A589">Profit/Loss Report Of All Time as at <?php echo date('D d S m,Y',time()); ?></b> </h4>
               <?php } ?>
                 <br>
                ...
                <tbody>
                     ...
                     if (isset($_POST['submit'])) {
                      ...
                      $endDate=$_POST['to'];
                      $total_Sales=0;
                       $getProductSalesReps=salesReportByDate($startDate,$endDate);
                       ...
                       $getReports=profitLossReportByDate($startDate,$endDate);
                      if ($getReports !=0) {
                        $x=0;
                      ...
                      $getExpenses=expensesReportByDate($startDate,$endDate);
                      if ($getExpenses !=0) {
                        $x=0;
                      ...
                      $total_service_sales=0;
                     $getserviceSalesReports= servicesalesReportByDate($startDate,$endDate);
                      if ($getserviceSalesReports !=0) {
                        $x=0;
                        foreach ($getserviceSalesReports as $getserviceSalesReport ) {
                          $total_service_sales +=$getserviceSalesReport->total_amount;
                        }
                      }
                       $total_salesAll=0;
                      $total_salesAll= $total_service_sales + $total_Sales;
                      $GrossProfit= $total_salesAll - $total_buying_cost;
                      $netProfit= $GrossProfit - $total_expenses;
                     ?>

                       <tr>
                      <td>Total Product Sales</td>
                      <td>Ksh <?php echo number_format($total_Sales,2);  ?></td>
                    
                      </tr>
                       <tr>
                      <td>Total Services Sales</td>
                      <td>Ksh <?php echo number_format($total_service_sales,2);  ?></td>
                    
                      </tr>
                        <tr>
                      <td><b>Total Sales</b></td>
                      <td><b>Ksh <?php echo number_format($total_salesAll,2);  ?></b></td>
                    
                      </tr>
                      <tr>
                      <td>Total Buying Cost</td>
                      <td>Ksh <?php echo number_format($total_buying_cost,2) ?></td>
                    
                      </tr>
                      <tr>
                      <td><b>Total Gross Profit</b></td>
                      <td><b>Ksh <?php echo number_format($GrossProfit,2); ?></b></td>
                      ...
                      <td><b>Ksh<?php echo number_format($netProfit,2) ?></b></td>
                     ...
                     $getserviceReports= serviceSalesReportAll();
                     if ($getserviceReports !=0) {
                        $x=0;
                        foreach ($getserviceReports as $getserviceReport ) {
                          $total_service_sales +=$getserviceReport->paid_amount;
                        }
                      }
                      $total_salesAll=0;
                      $total_salesAll= $total_service_sales + $total_Sales;
