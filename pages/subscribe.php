 ...
 <?php require_once('include/top_nav.php')?>
  ...
  <div class="content-wrapper">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-4">
          <div class="bg-white"><a href="renew_subscription?guidID=1month" title="Profit-Loss Statement"><h4 class="text-green"><b class="fa fa-bookmark text-gray"></b> 1 Month
      <br>
   @ Ksh 400</h4></a> 
 </div>
        </div>
        <div class="col-md-4">
          <div class="bg-white"><a href="report_stock" title="Stock Reports"><h4 class="text-green"><b class="fa fa-bookmark text-gray"></b> 1 Year <br> @ 4000</h4></a></div>
        </div>
      </div>
