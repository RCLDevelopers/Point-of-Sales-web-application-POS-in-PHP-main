        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                      <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i> EDIT CUSTOMER </h3>
                  </div>
                  <div class="col-md-8">
          ...
          <div class="card card-">
              ...
              if (isset($_POST['submit'])) {
                ...
                $phone=$_POST['phone'];
                 ...
                 $update=updatecustomer($customer_ID,$name,$email,$phone,$address,$date_of_birth);
                 if ($update =='success') {
                        $activity='Updated customer with name '.$name.' and email '.$email;
                          createActivity_logs($activity);
                        echo '<script> alert("Customer updated Successfully") </script>';
                 
                    echo '<script> window.location="edit_customer?guidID='.$customer_ID.'" </script>';
                      
                      }else{
                     echo '<script> alert("Sorry! something went wrong Please try again") </script>';
                 
                   echo '<script> window.location="edit_customer" </script>';
              ...
              <form method="POST" action="edit_customer?guidID=<?php echo $getcustomer->customer_ID ?>" class="form form-responsive" enctype="multipart/form-data">
                <div class="card-body">
                   ...
                   <div class="row form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter Supplier Name" value="<?php echo $getcustomer->customer_name ?>" required >
                  </div>
                   <div class="col-md-6">
                    <label for="phone" class="">Phone</label>
                    
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter Contact" value="<?php echo $getcustomer->phone ?>" required>
                  </div>
                </div>
                <div class="row form-group">
                  ...
                  <label for="email" class="">Email </label>
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter email" value="<?php echo $getcustomer->email ?>">
                  
                  </div>
                  <div class="col-md-6">
                    <label for="address" class="">Address</label>
                    
                    <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address" value="<?php echo $getcustomer->address ?>" >
                  </div>
                </div>
                <div class="row form-group">
                    
                  <div class="col-md-6">
                  <label for="dof" class="">Date of Birth </label>
                   
                    <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" placeholder="Enter email" value="<?php echo $getcustomer->date_of_birth ?>">
