        ...
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="card-header">
                <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-hospital"></i> MANAGE PURCHASE</h3>
              </div>
                  ...
                  <td><?php echo $getPurchase->gtotal_amount ?></td>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="purchase_invoice?guidID=<?php echo $getPurchase->purchase_ID ?>" class="btn btn-success"><i class="fas fa-eye"></i></a>
                        <a href="edit_purchase?guidID=<?php echo $getPurchase->purchase_ID ?>&invoice_no=<?php echo $getPurchase->invoice_no?>&date=<?php echo $getPurchase->purchase_date ?>&supplier=<?php echo $getPurchase->supplier_ID ?>&det=<?php echo $getPurchase->purchase_details ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                        <a href="delete_purchase?guidID=<?php echo $getPurchase->purchase_ID ?>" onclick="return confirm('Are you sure you want to delete Sale?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                     <?php   }
