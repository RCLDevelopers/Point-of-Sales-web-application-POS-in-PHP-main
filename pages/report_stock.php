        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i>STOCK REPORT </h3>
                  </div>
                  <div class="col-md-8">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <!-- Main content -->
           <!-- <form method="POST" action="report_stock.php">
              <div class="row">
            ...
            <div class="invoice p-3 mb-3" id="print">
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  ...
                  <?php }else{ ?>
                 <h4 style="text-align: center;"> <b style="color: #17A589">Stock Report as at <?php echo date('D dS m,Y',time()); ?></b> </h4>
               <?php } ?>
                 <br>
                ...
                <thead style="color:#17A589 ">
                  <tr>
                   <th class="all">#</th>
                    ...
                    <th class="all">Manufacturer</th>
                    

                    <th class="all">Sold Qty</th>
                    <th class="all">Avail Stock</th>
                ...
                <tbody>
                     ...
                     if (isset($_POST['submit'])) {
                      ...
                      $endDate=$_POST['to'];
                       $getproducts=stockReportByDate($startDate,$endDate);
                      if ($getproducts !=0) {
                        $x=0;
                    ...
                    <td><?php echo $getproduct->short_name ?></td>
