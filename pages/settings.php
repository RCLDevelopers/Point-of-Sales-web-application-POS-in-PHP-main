        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                      <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-wrench"></i> GENERAL SETTINGS </h3>
                  </div>
                  <div class="col-md-8">
          ...
          <div class="card card-">
              ...
              if (isset($_POST['submit'])) {
                ...
                if(move_uploaded_file($tmp_name,$location.$logo)){
                     $check=checkIfProfileisCreatedAlready();
                     if ($check ==1) {
                       # update
                      $update=updateCompanyProfile($title,$name,$email,$contact,$address,$logo);
                       if ($update =='success') {
                   ...
                   echo '<script> window.location="settings" </script>';
                      ...
                      //create profile
                      $create=createCompanyProfile($title,$name,$email,$contact,$address,$logo);
                      if ($create =='success') {
                        $activity='Create company profile ';
                          createActivity_logs($activity);
                        echo '<script> alert("Profile updated Successfully") </script>';
                 ...
                 echo '<script> window.location="add_user" </script>';
                    ...
                    $check=checkIfProfileisCreatedAlready();
                     ...
                     $update= updateCompanyProfilewithoutLogo($title,$name,$email,$contact,$address);
                     if ($update =='success') {
                        $activity='Update company profile ';
                          createActivity_logs($activity);
                        echo '<script> alert("Profile updated Successfully") </script>';
                   ...
                   echo '<script> window.location="settings" </script>';
                      ...
                      //create profile without logo
                      $create=createCompanyProfileWithoutLogo($title,$name,$email,$contact,$address);
                      if ($create =='success') {
                        $activity='Create company profile ';
                          createActivity_logs($activity);
                        echo '<script> alert("Profile updated Successfully") </script>';
              ...
              $address='';
              $logo='';
              $getProfiles=getCompanyProfileAll();
              if ($getProfiles !=0) {
                foreach ($getProfiles as $getProfile) {
                  $title=$getProfile->name;
                  $name=$getProfile->name;
                  $email=$getProfile->email;
                  $contact=$getProfile->contact;
                  $address=$getProfile->address;
                  $logo=$getProfile->logo;
                }
              }
              ?>
              <form method="POST" action="settings" class="form form-responsive" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="col-md-6">
                  <label for="tile" class="">Company Title </label>
                ...
                <div class="row form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="contact" placeholder="Enter Contact" value="<?php echo $contact ?>">
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row form-group">
                  ...
                  <label for="logo" class="">Logo </label>
                    ...
                    <br>
                     <?php
                      if ($logo !='') { ?>
                        <img src="uploads/<?php echo $logo ?>" class="img img-responsive" width="60px" height="60px" align="center" id="output_image" style="display: block" />
                      <?php }else{
                     ?>
