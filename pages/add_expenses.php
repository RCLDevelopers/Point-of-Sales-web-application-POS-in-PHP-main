        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i> ADD EXPENSES </h3>
                  </div>
                  <div class="col-md-8">
          ...
          <div class="card card-">
              ...
              if (isset($_POST['submit'])) {
                ...
                $expense_date=$_POST['date'];
                 ...
                 $create=createExpenses($expense,$amount,$expense_date,$description);
                 if ($create =='success') {
                        $activity='Added new expense with name '.$expense.' and amount '.$amount;
                          createActivity_logs($activity);
                        echo '<script> alert("Expense added Successfully") </script>';
                 
                    echo '<script> window.location="add_expenses" </script>';
              ...
              <form method="POST" action="add_expenses" class="form form-responsive" enctype="multipart/form-data">
                <div class="card-body">
                   ...
                   <div class="row form-group">
                    ...
                    <input type="text" class="form-control" id="expense" name="expense" placeholder="Enter Expense " required >
                  </div>
                   <div class="col-md-6">
