        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                     <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-users"></i> MANAGE CUSTOMER
                </h3>
                  </div>
                  <div class="col-md-8">
                ...
                <tbody>
                      ...
                      if ($getcustomers !=0) {
                        ...
                        foreach ($getcustomers as $getcustomer ) {
                          $x++;?>
                           <tr>
                    <td><?php echo $x ?></td>
                    <td><?php echo $getcustomer->customer_name ?></td>
                    <td><?php echo $getcustomer->email ?></td>
                   
                    <td><?php echo $getcustomer->phone ?></td>
                    <td>
                      <?php 
                       if ($getcustomer->date_of_birth !=0){
                      echo date('D-M-Y',strtotime($getcustomer->date_of_birth));  
                    }else{
                      echo ' ';
                    }
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="edit_customer?guidID=<?php echo $getcustomer->customer_ID ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                        <a href="delete_customer?guidID=<?php echo $getcustomer->customer_ID ?>" onclick="return confirm('Are you sure you want to delete Customer?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                     <?php   }
