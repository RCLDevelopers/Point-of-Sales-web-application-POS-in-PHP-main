        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i>RETURN  INVOICE </h3>
                  </div>
                  <div class="col-md-8">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            $total=0;
            $sales_return_ID='';
            if (isset($_GET['salesID']) && isset($_GET['returnID'])) {
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <?php
                      $total_deduction=0;
                      $getDetails=getSalesReturnDetailsByRetunID($sales_return_ID);
                      if ($getDetails !=0) {
                        $x=0;
                         foreach ($getDetails as $getDetail) {
                      $x++;
                      $sub_total +=$getDetail->selling_price * $getDetail->return_quantity;
                      $total_deduction +=$getDetail->return_deduction;
                      ...
                      <td><?php echo $getDetail->percent_deduction;?></td>
                      <td><?php echo $getDetail->return_deduction;?></td>
                      
                      <td><?php echo $getDetail->selling_price * $getDetail->return_quantity;?></td>
                     </tr>
                       <?php
                           }
                           }
