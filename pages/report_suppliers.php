        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i>SUPPLIER REPORT </h3>
                  </div>
                  <div class="col-md-8">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <!-- Main content -->
            <form method="POST" action="report_suppliers">
              <div class="row">
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  ...
                  $fromstr=strtotime($from);$tostr=strtotime($to);
                   ?>
                  <h4 style="text-align: center;" > <b style="color: #17A589">Supplier Report  From <?php echo date('D d S m,Y',$fromstr); ?> TO <?php echo date('D d S m,Y',$tostr); ?> </b></h4>
                  <?php }else{ ?>
                 <h4 style="text-align: center;" > <b style="color: #17A589">Supplier Report Of All Time as at <?php echo date('D d S m,Y',time()); ?></b> </h4>
               <?php } ?>
                 <br>
                ...
                <tbody>
                     ...
                     if (isset($_POST['submit'])) {
                      ...
                      $endDate=$_POST['to'];
                       $getsuppliers=supplierReportByDate($startDate,$endDate);
                      if ($getsuppliers !=0) {
                        $x=0;
                    ...
                    <td><?php echo $getsupplier->phone ?></td>
                     ...
                     <?php   }
                      ...
                      $getsuppliers=supplierReportAll();
                      if ($getsuppliers !=0) {
                        $x=0;
                        foreach ($getsuppliers as $getsupplier ) {
                          $x++;?>
