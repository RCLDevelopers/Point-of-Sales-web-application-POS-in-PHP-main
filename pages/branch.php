      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="card card-default">
                ...
                <div class="row">
                  <div class="col-md-4" >
                      <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-list-alt"></i> BRANCH</h3>
                  </div>
                  <div class="col-md-8">
        ...
        <div class="row">
          ...
          <div class="card card-info">
              ...
              if (isset($_POST['submit'])) {
                ...
                $check=checkifbranchExist($branch_name);
                if ($check ==1) {
                  echo '<script> alert("branch already exist") </script>';
                }else{
                    echo $save=createbranch($branch_name);
                if ($save =='success') {
                  $activity='Create a new branch with name '.$branch_name;
                  createActivity_logs($activity);
                   echo '<script> alert("Added branch Successfully") </script>';
                      ...
                      if ($getbranchs !=0) {
                        ...
                        $x++;
                         ?>
                          <tr>
                            <td><?php echo $x ?></td>
                            <td><?php echo $getbranch->branch_name?></td>
                            <td><a href="deactivate_branch?guidID=<?php echo $getbranch->branch_ID  ; ?>" onclick="return confirm('Delete branch?')"  class='btn btn-danger'><i class="fas fa-trash"></1> Delete</a></td>
                          </tr>
