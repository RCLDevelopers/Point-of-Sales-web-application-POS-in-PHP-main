        ...
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="card-header">
                <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-hospital"></i> MANAGE ORDERS</h3>
              </div>
                   ...
                   <?php } ?>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        ...
                        <a href="edit_order?guidID=<?php echo $getOrder->order_ID ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
