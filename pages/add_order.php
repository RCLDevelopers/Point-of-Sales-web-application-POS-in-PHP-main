        ...
        <div class="row">
          ...
          <div class="card card-">
              ...
              foreach ($getcustomers as $getcustomer ) { 
                 ...
                 $create=createOrder($customer_ID,$order_title,$description,$order_date);
                 if ($create =='success') {
                        $activity='Created new order with title '.$order_title;
                          createActivity_logs($activity);
                           sendSmsToCustomer($phone,$customer_name);
                        echo '<script> alert("Order added Successfully") </script>';
                 
                    echo '<script> window.location="add_order" </script>';
...
"MessageParameters": [
    {
        "Number": '. $phone .',
        "Text": "Dear ' .$customer_name .', We have received your order and we are working on it.We will notify you when is ready.Thank you for choosing Aluta Brands Media."
    }
]
}',
...
return $response; 
              ...
              <form method="POST" action="add_order" class="form form-responsive" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <input type="text" class="form-control" id="order_title" name="order_title" placeholder="Enter order title" required>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row form-group">
                  ...
                  <label for="order_date" class="">Order Date </label>
                    ...
                    <input type="date" class="form-control" id="order_date" name="order_date" placeholder="Enter order" required >
