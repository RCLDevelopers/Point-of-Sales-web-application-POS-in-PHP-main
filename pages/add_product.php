                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                       <div class="card card-">
                          ...
                          $actual_price=$_POST['actual_price'];#buying price
                          ...
                          $discount=0;
                          $batch_id='B/F';
                          $checkemail= checkIfproductExist($product_name);
                          if ($checkemail ==1) {

                          echo '<script> alert("product with that name already exist") </script>';
                          echo '<script> window.location="add_product" </script>';
                          }
                          ...
                          if(move_uploaded_file($tmp_name,$location.$image)){
                           ...
                           # create with image
                          $create=createproductWithImage($productID,$product_name,$supplier_id,$category,$quantity,$actual_price,$selling_price,$image);
                           if ($create =='success') {
                            
                            $reg=registerStockBF($purchase_ID,$supplier_id,$invoice_no,$purchase_date,$purchase_details,$total_discount,$total_amount,$paid_amount,$due_amount,$product_ID,$quantity,$actual_price,$discount,$batch_id);
                             if ($reg =='success') {
                              $activity='Created new product with name '.$product_name;
                              createActivity_logs($activity);
                              $Stockactivity='Added stock B/F '.$invoice_no;
                               $savelog=createActivity_logs($Stockactivity);
                          ...
                          //create without logo
                          $create= createproductWithoutImage($productID,$product_name,$supplier_id,$category,$quantity,$actual_price,$selling_price);
                          if ($create =='success') {
                            
                            $reg=registerStockBF($purchase_ID,$supplier_id,$invoice_no,$purchase_date,$purchase_details,$total_discount,$total_amount,$paid_amount,$due_amount,$productID,$quantity,$actual_price,$discount,$batch_id);
                             if ($reg =='success') {
                              $activity='Created new product with name '.$product_name;
                              createActivity_logs($activity);
                              $Stockactivity='Added stock B/F '.$invoice_no;
                          ...
                          <form method="POST" action="add_product" class="form form-responsive" enctype="multipart/form-data">
                          <div class="card-body">
                          ...
                          <div class="col-md-6">
                          <label for="shortName" class="">Supplier </label>
                          ...
                          <input type="text" class="form-control" id="actual_price" name="actual_price" placeholder="Enter Buying Price" >
                          </div>
                          <div class="col-md-6">
