        ...
        <div class="row" style="padding-top: 15px;padding-bottom: 15px">
           <div class="col-md-12">
             <button type="submit" name="submit" class="btn btn-info" style="background-color: ;color: white">
              ...
              <button type="submit" name="submit" class="btn btn-success" style="background-color:#17A589 ;color: white"><a href="manage_stock" style="color:#fff"><i class="nav-icon fas fa-list"></i> View Stock</a></button>
              <br>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="card-header">
                <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-hospital"></i> PRODUCT OUT OF STOCK</h3>
              </div>
              ...
              <div class="card-body table-responsive p-0">
                ...
                <thead style="color:#17A589 ">
                  <tr>
                   ...
                   <th class="all">Category</th>
                    ...
                    <th class="all">Remaining Stock</th>
                ...
                <tbody>
                     <?php
                      $getproducts=getproductOutOfStock();
                      if ($getproducts !=0) {
                        $x=0;
