        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                     <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-user"></i> MANAGE USER</h3>
                  </div>
                  <div class="col-md-8">
          ...
          <div class="col-md-12">
              ...
              <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    ...
                    <td><?php echo getRolesByID($getuser->role)?></td>
                    <td><?php if ($getuser->status =='Inactive') { ?>
                   ...
                   <?php 
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="edit_user?guidID=<?php echo $getuser->user_ID ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                        <a href="delete_user?guidID=<?php echo $getuser->user_ID ?>" onclick="return confirm('Are you sure you want to deactivate User?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                     <?php   }
