      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <!-- Main content -->
            <form method="POST" action="report_service_sales">
              <div class="row">
              ...
              <div class="row">
                <div class="col-12 table-responsive p-0">
                  ...
                  $fromstr=strtotime($from);$tostr=strtotime($to);
                   ?>
                  <h4 style="text-align: center;" > <b style="color: #17A589;padding-left: 10px;">  Service Done Report  From <?php echo date('D d S m,Y',$fromstr); ?> TO <?php echo date('D d S m,Y',$tostr); ?> </b></h4>
                  <?php }else{ ?>
                 <h4 style="text-align: center;" > <b style="color: #17A589;text-align: center;padding-left: 10px "> Service Done Report Of All Time as at <?php echo date('D d S m,Y',time()); ?></b> </h4>
               <?php } ?>
                 <br>
                ...
                <tbody>
                     ...
                     if (isset($_POST['submit'])) {
                      ...
                      $endDate=$_POST['to'];
                       $getReports=getserviceSalesByDate($startDate,$endDate);
                      if ($getReports !=0) {
                        $x=0;
                        foreach ($getReports as $getReport ) {
                            $total_amount +=$getReport->total_amount ;
                          $x++;?>
                            <tr>
                    <td><?php echo $x ?></td>
                    <td><?php echo date('M/D/Y',strtotime($getReport->invoice_date))  ?></td>
                    <td><?php echo $getReport->invoice_no  ?></td>
                    <td><?php 
                      if($getReport->customer_ID =='WalkIn'){
                          echo 'Walking Customer';
                        }else{
                      $getCustomers=getcustomerByID($getReport->customer_ID) ;
                    if ($getCustomers !=0) {
                    ...
                    ?></td>
                    <td><?php echo $getReport->total_amount ?></td>
                  ...
                  <tr>
                    ...
                    <td><b>Ksh <?php echo number_format($total_amount,2) ?></b></td>
