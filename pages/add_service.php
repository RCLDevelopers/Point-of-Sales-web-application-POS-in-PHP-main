                  ...
                  <div class="tab-pane active" id="tab_2">
                    <?php
                     if (isset($_POST['submitService'])) {
                         ...
                         $checkService= checkifServiceAlreadyExist($serviceName);
                          if ($checkService ==1) {

                          echo '<script> alert("Service with that name already exist") </script>';
                          echo '<script> window.location="add_service" </script>';
                          }
                          $saveService=createService($serviceName,$cost);
                              if ($saveService =='success') {
                              $activity='Created new service with name '.$serviceName;
                    ...
                    ?>
                        <form method="POST" action="add_service" class="form form-responsive" enctype="multipart/form-data">
                          <div class="card-body">
                          ...
                          <div class="col-md-6">
                          <label for="logo" class="">Cost </label>

                          <input type="number" class="form-control" id="cost" name="cost" value="0" placeholder="Enter Price" >
