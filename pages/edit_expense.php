...
<?php require_once('include/functions/expenses.php')?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-edit"></i> EDIT EXPENSES </h3>
                  </div>
                  <div class="col-md-8">
          ...
          <div class="card card-">
              ...
              if (isset($_POST['submit'])) {
               $expense_ID=$_GET['guidID'];
                ...
                $expense_date=$_POST['date'];
                 ...
                 $update=updateExpenses($expense_ID,$expense,$amount,$expense_date,$description);
                 if ($update =='success') {
                        $activity='Updated expense with name '.$expense.' and amount '.$amount;
                          createActivity_logs($activity);
                        echo '<script> alert("Expense Updated Successfully") </script>';
                 
                    echo '<script> window.location="edit_expense" </script>';
              ...
              <?php
               if (isset($_GET['guidID'])) {
                $expenseID=$_GET['guidID'];
               $getExpenses= getExpensesByID($expenseID);
               if ($getExpenses !=0) {
                  foreach ($getExpenses as $getExpense) { ?>
                    
               
              <form method="POST" action="edit_expense?guidID=<?php echo $_GET['guidID']?>" class="form form-responsive" enctype="multipart/form-data">
                <div class="card-body">
                  
                   <div class="row form-group">
                    <div class="col-md-6">
                    <label for="name" class="">Expense</label>
                    
                    <input type="text" class="form-control" id="expense" name="expense" placeholder="Enter Expense " value="<?php echo $getExpense->expense ?>" required >
                  </div>
                   <div class="col-md-6">
                    <label for="phone" class="">Amount</label>
                    
                    <input type="text" class="form-control" id="amount" name="amount" placeholder="Enter Amount" value="<?php echo $getExpense->amount ?>" required>
                  </div>
                </div>
                <div class="row form-group">
                  ...
                  <label for="email" class="">Date </label>
                    ...
                    <input type="date" class="form-control" id="date" name="date" value="<?php echo $getExpense->expense_date ?>" placeholder="Enter Date" >
                  
                  </div>
                  <div class="col-md-6">
                    <label for="address" class="">Description</label>
                    
                    <textarea class="form-control" name="description" id="description"><?php echo $getExpense->description ?></textarea>
                  </div>
                </div>
