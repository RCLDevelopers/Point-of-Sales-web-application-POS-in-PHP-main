        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i> ADD CUSTOMER </h3>
                  </div>
                  <div class="col-md-8">
          ...
          <div class="card card-">
              ...
              if (isset($_POST['submit'])) {
                ...
                $phone=$_POST['phone'];
                 ...
                 $check=checkifCustomerAlreadyExist($name,$email);
                 if ($check ==1) {
                   echo '<script> alert("Customer with that name and email already exist") </script>';
                 
                    echo '<script> window.location="add_supplier" </script>';
                 }else{
                 $create=createCustomer($name,$email,$phone,$address,$date_of_birth);
                 if ($create =='success') {
                        $activity='Created new customer with name '.$name.' and email '.$email;
              ...
              <form method="POST" action="add_customer" class="form form-responsive" enctype="multipart/form-data">
                <div class="card-body">
