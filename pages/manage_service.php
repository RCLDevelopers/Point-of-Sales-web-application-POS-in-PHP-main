        ...
        <div class="row" style="padding-top: 15px;padding-bottom: 15px">
           <div class="col-md-12">
             <button type="submit" name="submit" class="btn btn-info" style="background-color: ;color: white">
              <a href="add_product" style="color:#fff"><i class="nav-icon fas fa-plus"></i> Add Product / Service</a></button>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="card-header">
                <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-hospital"></i> MANAGE SERVICES</h3>
              </div>
              ...
              <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    ...
                    <td><?php echo $getService->cost ?></td>
                   <td><?php echo $getService->status ?></td>
                  
                  
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="edit_service?guidID=<?php echo $getService->service_ID ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                        <a href="delete_service?guidID=<?php echo $getService->service_ID ?>" onclick="return confirm('Are you sure you want to delete service?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                     <?php   }
