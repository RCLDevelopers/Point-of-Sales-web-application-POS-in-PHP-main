        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i>SALES REPORT </h3>
                  </div>
                  <div class="col-md-8">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <!-- Main content -->
            <form method="POST" action="report_sales">
              <div class="row">
              ...
              <div class="row">
                <div class="col-12 table-responsive p-0">
                  ...
                  $fromstr=strtotime($from);$tostr=strtotime($to);
                   ?>
                  <h4 style="text-align: center;" > <b style="color: #17A589">Product Sales Report  From <?php echo date('D d S m,Y',$fromstr); ?> TO <?php echo date('D d S m,Y',$tostr); ?> </b></h4>
                  <?php }else{ ?>
                 <h4 style="text-align: center;"> <b style="color: #17A589">Product Sales Report Of All Time as at <?php echo date('D d S m,Y',time()); ?></b> </h4>
               <?php } ?>
                 <br>
                ...
                <tbody>
                      ...
                      if ($getReports !=0) {
                        ...
                        foreach ($getReports as $getReport ) {
                          ...
                          $x++;?>
                           <tr>
                    <td><?php echo $x ?></td>
                    <td><?php echo $getReport->product_name ?></td>
                    <td><?php echo $getReport->quantity  ?></td>
                    <td><?php echo $getReport->actual_price ?></td>
                    <td><?php echo $getReport->selling_price ?></td>
                    <td><?php echo $getReport->actual_price * $getReport->quantity ?></td>
                    <td><?php echo $getReport->selling_price * $getReport->quantity ?></td>
                    <td><?php echo ($getReport->selling_price * $getReport->quantity)-($getReport->actual_price * $getReport->quantity) ?></td>
                  </tr>
                     <?php   }
                      }
                      ...
                      if ($getSales !=0) {
                        ...
                        foreach ($getSales as $getSale ) {
                          $Total_profit += $getSale->total_amount;
                          $x++;?>
                           <tr>
                    <td><?php echo $x ?></td>
                  ...
                  <tr>
                    ...
                    <td><b>Ksh <?php echo number_format($Total_profit,2); ?></b></td>
                  </tr>
