        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
               <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                     <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-money"></i> MANAGE EXPENSES</h3>
                  </div>
                  <div class="col-md-8">
                      ...
                      if ($getExpenses !=0) {
                        ...
                        foreach ($getExpenses as $getExpense ) {
                          $x++;?>
                           <tr>
                    <td><?php echo $x ?></td>
                    <td><?php echo $getExpense->expense ?></td>
                    <td><?php echo $getExpense->amount ?></td>
                   
                    <td><?php echo $getExpense->expense_date ?></td>
                    
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="edit_expense?guidID=<?php echo $getExpense->expense_ID ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                        <a href="delete_expense?guidID=<?php echo $getExpense->expense_ID ?>" onclick="return confirm('Are you sure you want to delete Expenses?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                     <?php   }
