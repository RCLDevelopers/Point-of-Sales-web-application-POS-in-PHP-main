        ...
        <div class="row mb-2">
          ...
          <div class="card card-default">
              ...
              <div class="card-header" style="color: #17A589;font-size:">
                ...
                <div class="row">
                  <div class="col-md-4" >
                    <h3 class="card-title" style="color: #17A589;font-size:"><i class="nav-icon fas fa-plus"></i> ADD SUPPLIER </h3>
                  </div>
                  <div class="col-md-8">
          ...
          <div class="card card-">
              ...
              if (isset($_POST['submit'])) {
                ...
                $phone=$_POST['phone'];
                 ...
                 $check=checkifSupplierAlreadyExist($name,$email);
                 if ($check ==1) {
                   echo '<script> alert("Supplier with that name and email already exist") </script>';
                 
                    echo '<script> window.location="add_supplier" </script>';
                 }else{
                 $create=createSupplier($name,$email,$phone,$address);
                 if ($create =='success') {
                        $activity='Created new supplier with name '.$name.' and email '.$email;
              ...
              <form method="POST" action="add_supplier" class="form form-responsive" enctype="multipart/form-data">
                <div class="card-body">
